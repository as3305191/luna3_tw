...
{	
	virtual 	BOOL	__stdcall	Initialize(DWORD dwMaxFileNum,DWORD dwMaxFileHandleNumAtSameTime,DWORD dwMaxFileNameLen,DWORD dwSecretKey,FILE_ACCESS_METHOD accessMethod) = 0;
	// 090831 ShinJS --- Pack���� Create/Load �� Share Mode ���� �߰��Ͽ� ��Ƽ Ŭ���̾�Ʈ ������� ��.
	virtual		void*	__stdcall	MapPackFile(char* szPackFileName, DWORD dwSecretKey, BOOL bFileShareMode=FALSE) = 0;
