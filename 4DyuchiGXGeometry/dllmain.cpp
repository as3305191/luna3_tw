         ...
         LPVOID* ppv)
{
	...
	if (CLSID_4DyuchiGXGeometry == rclsid)
	{
		hr = E_OUTOFMEMORY;
		pIFactory = new CF4DyuchiGXGeometry;
		if (pIFactory)
		{
...
{
	HRESULT hr;
	I4DyuchiGXGeometry*	pGeometry = new CoGeometry;
	if (!pGeometry)
	{
		hr = E_OUTOFMEMORY;
		goto lb_return;
...
STDAPI DllRegisterServer(void)
{
 ...
 // DWORD		size = sizeof(TCHAR);
  ...
  StringFromGUID2(CLSID_4DyuchiGXGeometry, wszID, GUID_SIZE);
  ...
  SetRegKeyValue(
    TEXT("CTS.CLSID_4DyuchiGXGeometry.1"),
    TEXT("CLSID"),
    szID);
  ...
  SetRegKeyValue(
    TEXT("CTS.CLSID_4DyuchiGXGeometry"),
    NULL,
   TEXT("CLSID"));
...
STDAPI DllUnregisterServer(void)
{
  ...
  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_4DyuchiGXGeometry\\CurVer"));
  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_4DyuchiGXGeometry\\CLSID"));
  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_4DyuchiGXGeometry"));

  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_4DyuchiGXGeometry.1\\CLSID"));
  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_4DyuchiGXGeometry.1"));
