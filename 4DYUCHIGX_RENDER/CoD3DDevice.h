...
//	CProjectedIBManager*			GetPrjIBManager()		{return &m_PrjIBManager;}
	...
	void							SetDefaultDiffuseTexture(LPDIRECT3DDEVICE9 pDevice,DWORD dwTexStageIndex) {m_pTextureManager->SetDefaultDiffuseTexture(pDevice,dwTexStageIndex);}
	void							SetDefaultBumpTexture(LPDIRECT3DDEVICE9 pDevice,DWORD dwTexStageIndex) {m_pTextureManager->SetDefaultBumpTexture(pDevice,dwTexStageIndex);}
	...
	LPDIRECT3DTEXTURE9				GetDynamicLightTexture(DWORD dwIndex);
...
//	BOOL							EndCreateProjectionMap(DWORD dwShadowTextureIndex);
    ...
    void							SetMultiSample(D3DMULTISAMPLE_TYPE wVal) { MSType = wVal; }
	D3DMULTISAMPLE_TYPE				GetMultiSample() { return MSType; }
