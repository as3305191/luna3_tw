         ...
         LPVOID* ppv)
{
	...
	if (CLSID_4DyuchiGXRenderer == rclsid)
	{
		hr = E_OUTOFMEMORY;
		pIFactory = new CF4DyuchiGXRenderer;
		if (pIFactory)
		{
...
{
	HRESULT hr;
	I4DyuchiGXRenderer*	pRenderer = new CoD3DDevice;
	if (!pRenderer)
	{
		hr = E_OUTOFMEMORY;
		goto lb_return;
...
STDAPI DllRegisterServer(void)
{
  ...
  SetRegKeyValue(
    TEXT("CTS.CODE.1"),
    NULL,
    TEXT("4DyuchiGX 3D Engine Renderer 2001. yuchi"));
  
  SetRegKeyValue(
    TEXT("CTS.CLSID_4DyuchiGXRenderer.1"),
    TEXT("CLSID"),
    szID);
  ...
  SetRegKeyValue(
    TEXT("CTS.CLSID_4DyuchiGXRenderer"),
    NULL,
   TEXT("4DyuchiGX 3D Engine Renderer 2001. yuchi"));
...
STDAPI DllUnregisterServer(void)
{
  ...
  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_4DyuchiGXRenderer\\CurVer"));
  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_4DyuchiGXRenderer\\CLSID"));
  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_4DyuchiGXRenderer"));

  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_4DyuchiGXRenderer.1\\CLSID"));
  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_4DyuchiGXRenderer.1"));
