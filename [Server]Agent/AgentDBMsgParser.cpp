...
void FriendAddFriendByName(DWORD CharacterIDX, char* TargetName) //CharacterIDX : ½ÅÃ»?Î, TargetID : ½Â³«?Î
{
	if(IsCharInString(TargetName, "'"))	return;
...
void AddGuildFieldWarMoney( DWORD dwConnectionIndex, DWORD dwPlayerIdx, DWORDEX dwMoney )
{
	// 081012 LUJ, �Ϻ� ������ ���ν��� ȣ�� �� ��ҹ��ڱ��� ��ġ�ؾ� �Ѵ�. ��, dbo�� �ҹ��ڷ� �ؾ���. �̿� ��� ���ν��� �̸��� ������
	g_DB.FreeQuery( eAddGuildFieldWarMoney, dwConnectionIndex, "EXEC dbo.MP_GUILDFIELDWAR_ADDMONEY %d, %I64u",
		dwPlayerIdx, dwMoney );
}
	...
	case 0:		// login
		{
			...
			DWORDEX dweMoney = (DWORD)_atoi64((char*)pData->Data[3]);

			MSG_DWORDEX2 Msg;
			Msg.Category = MP_GUILD_WAR;
			Msg.Protocol = MP_GUILD_WAR_ADDMONEY_TOMAP;
			Msg.dweData1 = dwPlayerIdx;
			Msg.dweData2 = dweMoney;
