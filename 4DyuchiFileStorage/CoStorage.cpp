...
BOOL __stdcall CoStorage::Initialize(DWORD dwMaxFileNum,DWORD dwMaxFileHandleNumAtSameTime,DWORD dwMaxFileNameLen,DWORD dwSecretKey,FILE_ACCESS_METHOD accessMethod)
{
...
void* __stdcall CoStorage::MapPackFile(char* szPackFileName, DWORD dwSecretKey, BOOL bFileShareMode)
{
	...
	bResult = pPackFile->Initialize(this,m_pFileItemNameHash,szPackFileName,dwSecretKey,bFileShareMode);
