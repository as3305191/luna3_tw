...
#define CRYPTORNAME 10
#define MAX_CHARKEY_LENGTH 512
...
BOOL CPackFile::Initialize(CoStorage* pStorage,VBHASH_HANDLE pFileNameHash,char* szPackFileName, DWORD dwSecretKey, BOOL bFileShareMode)
{
...
lb_create_file:
	...
	DWORD dwShareMode = bFileShareMode == TRUE ? FILE_SHARE_READ | FILE_SHARE_WRITE : 0;
	m_hOriginalFile = CreateFile(szPackFileName,GENERIC_READ | GENERIC_WRITE,dwShareMode,NULL,dwOpenFlag,FILE_ATTRIBUTE_NORMAL,NULL);
...
BOOL CPackFile::EndCreatePackFile(LOAD_CALLBACK_FUNC pCallBackFunc)
{
	...
	//Keys
	DWORD Key1 = (DWORD)mKey1;
	DWORD Key2 = (DWORD)mKey2;
	DWORD Key3 = (DWORD)mKey3;
	DWORD Key4 = (DWORD)mKey4;
	DWORD Key5 = (DWORD)mKey5;
	DWORD Key6 = (DWORD)mKey6;
	DWORD Key7 = (DWORD)mKey7;
	DWORD Key8 = (DWORD)mKey8;
	DWORD Key9 = (DWORD)mKey9;
	DWORD Key10 = (DWORD)mKey10;

	m_Header.dwSecretKey = Key1+Key2+Key3+Key4+Key5+Key6+Key7+Key8+Key9+Key10;
...
lb_skip:
	...
	Initialize(m_pStorage,m_pPackFileNameHash,szFileName,20250813);
