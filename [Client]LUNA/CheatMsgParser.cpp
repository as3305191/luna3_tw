...
//---KES CHEAT CHANGESIZE
	...
	{
#ifdef _GMTOOL_
		if( MAINGAME->GetUserLevel() == eUSERLEVEL_GM && GMTOOLMGR->GetGMPower() != eGM_POWER_MASTER )
			return TRUE;
#endif

		MONEYTYPE money = 0;
		char tempmpney[MAX_PATH] = { 0 };
		char maxmoney[MAX_PATH] = { 0 };
		sprintf(maxmoney, "%I64u", MAX_INVENTORY_MONEY);
		sscanf(cheat, "%s %s", code, tempmpney);
		if (strlen(tempmpney) > strlen(maxmoney))
			money = MAX_INVENTORY_MONEY;
		else
			money = _atoi64(tempmpney);
		if (money < 0)
			money = 1;
		else if (money > MAX_INVENTORY_MONEY)
			money = MAX_INVENTORY_MONEY;
...
//			return TRUE;
	...
	{
		DWORDEX dwPoint;
		sscanf(cheat,"%s %I64u",code,&dwPoint);
	...
	// 081022 LYW --- CheatMsgPasrer : �� ����/��Ÿ �׽�Ʈ�� ���Ͽ� Pet���� GOD ��带 �����Ѵ�.
	...
	else if( strcmp( code, "GUILDUNIONCLEAR" ) == 0 )
	{
  	...
  	// 080820 LYW --- CheatMsgParser : npc ��ȯ ġƮ�� �߰�.
  	...
  	// 080827 LYW --- CheatMsgParser : ���� ���¸� �����ϴ� ġƮ�� �߰�.
	...
	if( strcmp( code, "HIDE_CHAR" ) == 0 )
	{
		if( OPTIONMGR->GetGameOption()->bHideOtherPlayer )
		{
			...
			CHATMGR->AddMsg(CTC_SYSMSG, "�ɼǺ��� : ĳ���� ���̱�" );
		}
		else
		{
			...
			OPTIONMGR->ApplyEnvironmemt();
			CHATMGR->AddMsg(CTC_SYSMSG, "�ɼǺ��� : ĳ����/�� �Ⱥ��̱�" );
		}

		return TRUE;
	}
	// 090116 ShinJS --- �� �Ⱥ��̱� �ɼǿ� ���� ������ ���� ����
	else if( strcmp( code, "HIDE_PET" ) == 0 )
	{
		if( OPTIONMGR->GetGameOption()->bHideOtherPet )
		{
			if( OPTIONMGR->GetGameOption()->bHideOtherPlayer )
			{
				CHATMGR->AddMsg(CTC_SYSMSG, "�ɼǺ������ : ĳ���� �Ⱥ��̱� �ɼ� �������Դϴ�." );
				return TRUE;
			}

			OPTIONMGR->GetGameOption()->bHideOtherPet = FALSE;
			OPTIONMGR->ApplyEnvironmemt();
			CHATMGR->AddMsg(CTC_SYSMSG, "�ɼǺ��� : �� ���̱�" );
		}
		else
		{
			OPTIONMGR->GetGameOption()->bHideOtherPet = TRUE;
			OPTIONMGR->ApplyEnvironmemt();
			CHATMGR->AddMsg(CTC_SYSMSG, "�ɼǺ��� : �� �Ⱥ��̱�" );
		}

		return TRUE;
	}
	// 090907 ShinJS --- ��ã�� ���� ������(�ð�,��ġ) Draw ���� ����
	...
	else if( strcmp( code, "VEHICLE_CHECK" ) == 0 )
	{
		...
		char* msg = (bOnOff == TRUE ? "����" : "����");
		CHATMGR->AddMsg(CTC_SYSMSG, "Ż�� �ð��˻� %s", msg );
		return TRUE;
	}
	...
	else if( strcmp( code, "UPDATEBEFF" ) == 0 )
	{
		...
		char* msg = (bOnOff == TRUE ? "����" : "����");
		CHATMGR->AddMsg(CTC_SYSMSG, "Beff File ��ε� : %s", msg );
		return TRUE;
	}
	...
	else if( strcmp( code, "PRINTSERVERTIME" ) == 0 )
	{
		...
		CHATMGR->AddMsg( CTC_SYSMSG, "���缭���ð� : %d-%d-%d %02d:%02d:%02d", 
