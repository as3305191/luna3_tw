...
void CPrivateWarehouseDialog::OnFakeStorageItemDivideCancel( LONG iId, void* p, DWORDEX param1, void * vData1, void * vData2 )
{
...
void CPrivateWarehouseDialog::OnFakeStorageItemDivideOk( LONG iId, void* p, DWORDEX param1, void * vData1, void * vData2 )
{
	...
	{
		ptDlg->m_divideMsg.ToDur			= (DURTYPE)param1;
		ptDlg->m_divideMsg.FromDur		= ptDlg->m_divideMsg.FromDur - (DURTYPE)param1;
