...
{
	if(pMsg->MemberInfo.dwMemberID == HEROID) //�߰��� ���
	{
		CHATMGR->AddMsg( CTC_SYSMSG, CHATMGR->GetChatMsg(98) );
		HERO->SetPartyIdx(pMsg->PartyID);

		OBJECTMGR->ApplyOverInfoOptionToAll();//--setpartyinfo�� �ι���ġ�°�? confirm
	}
	else //���Ŀ���
	{
	...
	// 080318 LUJ,	��Ƽ�� �߰��� �÷��̾��� ��ų�� �˻��ؼ� �߰����ش�. ��ų ������ ���� �������� ���۵��� �����Ƿ� Ŭ���̾�Ʈ���� ã�´�
...
void CPartyManager::ChangeMasterPartyResult(MSG_DWORD* pMsg) 
{
	...
	// 100127 ONS ����Ʈ��Ī 1:1ä�û��¿��� ��Ƽ���� �̾��������, ��Īç���� ��ư�� ���Ž�Ų��.
...
void CPartyManager::SetPartyInfo(PARTY_INFO* pmsg) 
{
	...
	OBJECTMGR->ApplyOverInfoOptionToAll();//�α����̳� ��Ƽ�� ������ ��
}
...
BOOL CPartyManager::IsMemberLogIn(int n)
{
	return m_Party.IsLogIn(n);
}
...
void CPartyManager::Party_Member_Login( void* pMsg )
{
	...
	{
		if(pmsg->MemberInfo.LifePercent)			// ���� ������ ��Ƽ��
			PICONMGR->CreatePartyIcon(pmsg->MemberInfo.dwMemberID, &pmsg->MemberInfo);
		else			// ������ ������ �ִ� ��Ƽ��
		{
