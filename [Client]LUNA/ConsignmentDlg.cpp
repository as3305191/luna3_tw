...
void CConsignmentDlg::SendRegistMsg()
{
	...
	float fCommission = (float)dwUnitPrice * (float)CONSIGNMENT_COMMISSION_RATE;	// ������ ���۽ô� "���������"�� ������.
...
void CConsignmentDlg::OnBuyItem( LONG iId, void* p, DWORDEX param1, void * vData1, void* vData2 )
{
	CConsignmentDlg* pDlg = (CConsignmentDlg*)vData1;

	char* pText = (char*)vData2;
	pDlg->m_dwBuyDurability = (DWORD)param1;
...
void CConsignmentDlg::OnCancelBuyItem( LONG iId, void* p, DWORDEX param1, void * vData1, void* vData2 )
{
	CConsignmentDlg* pDlg = (CConsignmentDlg*)vData1;
