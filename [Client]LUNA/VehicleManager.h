...
public:
	...
	void GetOn( DWORD dwPlayerID, DWORD dwVehicleID, DWORD dwSeatPos, DWORD dwMasterID, DWORDEX dwTollMoney, const char* szVehicleName, const char* szPlayerName ) const;	// 탑승 처리
