...
/*main title*/
	...
	// 080111 LYW --- WindowIDs : ���� ��й�ȣ �Է� â �߰�.
...
/*AI������IAa�ˡ���c*/
	...
	// 090521 ONS �ű����� inventory background �߰�
...
// LBS 03.10.16 Npc�ˡ�e��icA��E��?�ˢ� ��ic��?e----
	WINDOW_ID(NSI_LISTDLG),
	WINDOW_ID(NSI_LISTDLG2), //070724 LYW --- WindowIDs : ���ο� npc ��ȭâ �������� �ٲٸ鼭, ����Ʈ ���̾�α� �ϳ��� �� �߰�. �̸��� NSI_LISTDLG2�� �Ѵ�.
	WINDOW_ID(NSI_TOPBTN),	 //070725 LYW --- WindowIDs : ���ο� npc ��ȭâ �������� �ٲٸ鼭, ó��ȭ��, ��ȭ���� ��ư�� �߰���. 
	WINDOW_ID(NSI_ENDBTN),
	WINDOW_ID(NSI_QUESTBTN), // 090924 ShinJS --- ����Ʈ ����/�Ϸ� ��ư �߰�
...
/* A�ϩ��ˡ�?AI ����OAIAo */
	...
	// 090116 ShinJS --- ĳ���� �Ⱥ��̱� ���� ���� ������ disable ��Ű�� ���� �߰�
	WINDOW_ID(OTI_TEXT_HIDEOTHERPET),					// �� ���̱�/�Ⱥ��̱� �ؽ�Ʈ
	...
	WINDOW_ID(OTI_CB_MOVE_WINGS),

	// 090116 ShinJS --- �ɼ� Dialog�� ĳ����/�� üũ�ڽ� �߰�
	WINDOW_ID(OTI_CB_HIDEOTHERPLAYER),					// ĳ���� ���̱�/�Ⱥ��̱� üũ�ڽ�
	WINDOW_ID(OTI_CB_HIDEOTHERPET),					// �� ���̱�/�Ⱥ��̱� üũ�ڽ�
	WINDOW_ID(OTI_CB_HIDESTREETSTALLTITLE),				// ���� ���̱�/�Ⱥ��̱�
	// 100322 ONS ����Ʈ�˸��� �ڵ���� üũ�ڽ� �߰�
	WINDOW_ID(OTI_CB_AUTOQUESTNOTICE),

	WINDOW_ID(OTI_PB_CHATMODE),
	WINDOW_ID(OTI_PB_MACROMODE),
	WINDOW_ID(OTI_PB_WASDMODE),
	...
	WINDOW_ID(OTI_CB_SNOWEFFECT), // 2005.12.29�� �߰� 
...
//	WINDOW_ID(OTI_PB_ALLOFFEFFECT),
	...
	WINDOW_ID(OTI_HIDEPARTS_COSTUME_WING),
...
/*�����ϩ�E?A��E*/
    ...
    WINDOW_ID(ITTD_TRANSMOGDLG),
	WINDOW_ID(ITTD_TRANSMOGCOST),
	WINDOW_ID(ITTD_TRANSMOGICONDLG),
	WINDOW_ID(ITTD_TRANSMOGBTN),
    
	

	// 080228 LUJ, ��æƮ ��ȣ �� ǥ�õǴ� �̹���
	...
	// 090812 ShinJS --- ���� �������̽� ����, Category List Dialog, ���������� ���� cSpin, �������� ���� cStatic �߰�
	...
	// 080827 LYW --- WindowIDs : �ؽ�Ʈ ��¹ڽ� ��� ����ƽ ���̵� �߰�.
   	WINDOW_ID(PROGRESS_TEXT_IMAGE),
   	WINDOW_ID(PROGRESS_TEXT_AREA),
   	// 080904 LYW --- WindowIDs : ��� ��ư ���̵� �߰�.
	...
	// 080215 LUJ, �ɼ� ���� â. ApplyOptionDialog.bin
	...
	// 080916 LUJ, �ռ� â. ComposeDialog.bin
...
// SHOPITEM
	...
	//////////////////////////////////////////////////////////////////////
	// ����Ʈ ��Ī	2007/03/16	-	������.
	// �ΰ��� ���� "DateMatchingDlg.bin"���� �����Ѵ�.
	//WINDOW_ID(DMD_DATEMATCHINGDLG),	// ���� ���̾�α�.
	//	WINDOW_ID(DMD_CLOSEBTN),	// Ŭ���� ��ư.
	//	// �Ʒ����ʹ� DateMatchingUpperDlg.bin �� ����.
	//	WINDOW_ID(DMD_UPPERTAB1),		// ����Ʈ ��� ����Ʈ �� ��ư.
	//		WINDOW_ID(DMD_AGE_COMBO),				// ���� �޺��ڽ�
	//		WINDOW_ID(DMD_AGE_COMBO_BTN),			// ���� �޺� ��ư.
	//		WINDOW_ID(DMD_REGION_COMBO),			// �������� �޺��ڽ�
	//		WINDOW_ID(DMD_REGION_COMBO_BTN),		// ���� �޺� ��ư.
	//		WINDOW_ID(DMD_GENDER_CHECKBOX_MALE),	// ���� üũ�ڽ�, ����
	//		WINDOW_ID(DMD_GENDER_CHECKBOX_FEMALE),	// ���� üũ�ڽ�, ����
	//		WINDOW_ID(DMD_SEARCH_BTN),				// �˻��ϱ� ��ư
	//		WINDOW_ID(DMD_SEARCH_LIST),				// �˻� ��� ����Ʈ
	//		WINDOW_ID(DMD_REFRESH_BTN),				// ���ΰ�ħ ��ư
	//		WINDOW_ID(DMD_START_CHAT_BTN),			// ��ȭ�ϱ� ��ư
	//	WINDOW_ID(DMD_UPPERTAB2),		// 1:1 ä�� �� ��ư.
	//		WINDOW_ID(DMD_CHAT_WINDOW_LIST),		// 1:1 ä�� ��ȭ���� ����Ʈ
	//		WINDOW_ID(DMD_CHAT_EDIT),				// ä�ñ� �Է�â

	//	// �Ʒ����ʹ� DateMatchingLowerDlg.bin �� ����.
	//	WINDOW_ID(DMD_LOWERTAB1),		// ������ �� ��ư.
	//		WINDOW_ID(DMD_MY_NICKNAME),				// �� ���� �г���
	//		WINDOW_ID(DMD_MY_GENDER),				// �� ���� ����
	//		WINDOW_ID(DMD_MY_AGE),					// �� ���� ����
	//		WINDOW_ID(DMD_MY_REGION),				// �� ���� ��������
	//		WINDOW_ID(DMD_MY_GOOD_FEELING_DEGREE),		// �� ���� ȣ����
	//		WINDOW_ID(DMD_MY_GOOD_FEELING_ICONGRID),	// ����, ȣ��, ������
	//		WINDOW_ID(DMD_MY_BAD_FEELING_ICONGRID),		// ����, ��ȣ��, ������
	//		WINDOW_ID(DMD_MY_INTRODUCTION_EDIT),		// �ڱ� �Ұ�
	//		WINDOW_ID(DMD_CHANGE_MY_INTRODUCTION_BTN),	// �Ұ�����.
	//		WINDOW_ID(DMD_SAVE_MY_INTRODUCTION_BTN),	// �����ϱ�
	//	WINDOW_ID(DMD_LOWERTAB2),		// ������� �� ��ư.
	//		WINDOW_ID(DMD_PARTNER_NICKNAME),		// ��� ���� �г���
	//		WINDOW_ID(DMD_PARTNER_GENDER),			// ��� ���� ����
	//		WINDOW_ID(DMD_PARTNER_AGE),				// ��� ���� ����
	//		WINDOW_ID(DMD_PARTNER_REGION),			// ��� ���� ��������
	//		WINDOW_ID(DMD_PARTNER_GOOD_FEELING_DEGREE),		// ��� ���� ȣ����
	//		WINDOW_ID(DMD_PARTNER_GOOD_FEELING_ICONGRID),	// ����, ȣ��, ������
	//		WINDOW_ID(DMD_PARTNER_BAD_FEELING_ICONGRID),	// ����, ��ȣ��, ������
	//		WINDOW_ID(DMD_PARTNER_INTRODUCTION_EDIT),		// ����� �ڱ� �Ұ�
	//		WINDOW_ID(DMD_REGIST_PARTNER_BTN),			// ģ�����.
	//		WINDOW_ID(DMD_RECOMMEND_PARTNER_BTN),		// ��õ�ϱ�.
	//	WINDOW_ID(DMD_LOWERTAB3),		// ����Ʈ ��� ��.
	//		WINDOW_ID(DMD_DATE_LIST),					// ����Ʈ ��� ����Ʈ.
	...
	WINDOW_ID(DMD_START_CHAT_BTN),			// ��ȭ�ϱ� ��ư
	WINDOW_ID(DMD_SEARCH_LIST),				// �˻� ��� ����Ʈ
	WINDOW_ID(DMD_LISTSELECT_IMAGE),		// ����Ʈ ���� �̹���
	WINDOW_ID(DMD_LISTOVER_IMAGE),			// ����Ʈ ���� �̹���
	...
	// desc_hseos_����Ʈ ��_01
	// S ����Ʈ �� �߰� added by hseos 2007.11.13	2007.11.15
	WINDOW_ID(DMD_ENTER_DATEZONE_BTN),
	WINDOW_ID(DMD_ENTER_CHALLENGEZONE_BTN),
	// E ����Ʈ �� �߰� added by hseos 2007.11.13	2007.11.15
	...
	// desc_hseos_�йи�01
	// S �йи� �߰� added by hseos 2007.07.02	2007.10.16
	WINDOW_ID(FD_CHANGENICKNAME_BTN),			// �ʴ��û
	WINDOW_ID(FD_INVITE_BTN),					// ������
	WINDOW_ID(FD_REGISTEMBLEM_BTN),				// ȣĪ����
	WINDOW_ID(FD_CHANGENICKNAMEON_BTN),			// ȣĪON
	WINDOW_ID(FD_LEAVE_BTN),					// Ż��
	WINDOW_ID(FD_EXPEL_BTN),					// �߹�
	WINDOW_ID(FD_BREAKUP_BTN),					// ��ü
	WINDOW_ID(FD_FARM_MANAGE_BTN),				// �������
	// E �йи� �߰� added by hseos 2007.07.02	2007.10.16

	// desc_hseos_����ý���_01
	// S ����ý��� �߰� added by hseos 2007.08.24	2007.09.10	200.10.23
	...
	// E ����ý��� �߰� added by hseos 2007.08.24	2007.09.10	200.10.23
...
// 080225 LYW --- WindowIDs : Add window id for chatroom system.
	...
	// 090422 ShinJS --- Ż���� ���� �˾� ���̾�α� �߰�(RidePopupMenuDlg)
	...
	WINDOW_ID(HOUSING_REVOL_RESET_BTN),		//���ġ��ư 	
	WINDOW_ID(HOUSING_REVOL_SET_BTN),			//��ġ��ư
	WINDOW_ID(HOUSING_REVOL_DEL_BTN),			//����?
...
//-----------------------------------------------
	WINDOW_ID(MBI_NOBTNMSGBOX),	//-->��oY��ia��oA CN��o�Ϩ��ˡ��ˡ� ��ic��?eCIAU. CNE���ϡˡ�e��?�ˢ� �ˡ�i�����ϩ� ��O�ϡ��ˡ�A����I ��uE��iE.
	WINDOW_ID(MBI_EXIT),
	// 080121 LYW --- WindowIDs : ĳ���� ����â���� �̵� Ȯ�� �޽��� ���̵�.
...
// LBS 03.10.09 �ˡ�������u��uAo ��oU��o���� ANd�ˡ���c ��oAAU//////////////////////////////
	...
	WINDOW_ID(MBI_SHOPITEM_LOCK),		// �����۸� ������ ��������
	WINDOW_ID(MBI_REVIVE_PRESENTSPOT),	// ���ڸ� �г�Ƽ �޽����� ����ϱ� ���� ���̵�
	WINDOW_ID(MBI_REVIVE_TOWNSOPT),		// �������� �г�Ƽ �޽����� ����ϱ� ���� ���̵�
	...
	WINDOW_ID(MBI_GUILDFIELDWAR_REVIVE),	// ����� �� ��������� ��Ȱ ó��
...
// 080325 LYW --- WindowIDs : Add a window id for messagebox of chatroom system.
	...
	// 080821 LYW --- WindowIDs : ��ȯ �� ��Ż�� ���� �޽��� �ڽ� ���̵� �߰�.
   	WINDOW_ID(MBI_RECALLPORTAL_NOTUSE),
   	WINDOW_ID(MBI_RECALLPORTAL_CHANGEMAP),
   
   	// 080827 LYW --- WindowIDs : ��ȯ ���� �˸�â�� ���� �޽��� �ڽ� ���̵� �߰�.
   	WINDOW_ID(MBI_NPCRECALLFAILED),
   
   	// 080828 LYW --- WindowIDs : npc ���� ��ų ��û�� �ʿ��� �޽��� �ڽ� ���̵� �߰�.
   	WINDOW_ID(MBI_NPCBUFFSKILL),
   
   	// 080922 LYW --- WindowIDs : ��� �ý��� �޽��� �ڽ� ���̵� �߰�.
   	WINDOW_ID(MBI_SIEGEWARFLAG),
	// 080929 LYW --- WindowIDs : ��� �ý��� ���� �޽��� ���̵� �߰�.
...
//------- DIVIDEBOX��?�ˢ硧u���� ��ic��?e
	...
	//��ũ����
	WINDOW_ID(SC_STC_TIME), //����ƽ(�ð�)
	WINDOW_ID(SC_MAINDLG), //���̾�α�
	...
	WINDOW_ID(MAX_IDENUM),				// ���Ⱑ ���̶� �ǹ��ε�.? - 2007/03/16 ������
