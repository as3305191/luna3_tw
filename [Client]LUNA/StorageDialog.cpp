...
void CStorageDialog::LoadStorageListInfo()
{
	...
	{
		m_StorageListInfo.Storage[n].MaxCellNum = 36*(n+1);			// ShinJS 090522 --- â�� Cell ���� ����
...
void CStorageDialog::Linking()
{
	...
	for(int i=0; i<MAX_STORAGELIST_NUM; ++i)
	{
		...
		m_StorageCtlListArray[eStorageMode_StorageWare1+i].AddTail((cStatic*)GetWindowForID(PYO_MONEYIMG)); //���� �׸�
		m_StorageCtlListArray[eStorageMode_StorageWare1+i].AddTail((cStatic*)GetWindowForID(PYO_MONEYBACKIMG));
		m_StorageCtlListArray[eStorageMode_StorageWare1+i].AddTail(m_pMoney); //���� �̹���
...
{
	// 071125 LYW --- ExchangeDialog : ���� ���� �� ������ â�� ���� �Ұ� ó��.
...
void CStorageDialog::SetStorageMoney(DWORDEX Money)
{
