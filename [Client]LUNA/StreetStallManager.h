...
public:
	...
	BOOL LinkItem(POSTYPE pos, ITEMBASE ItemInfo, WORD Volume, DWORDEX Money);
	...
	void RegistItemEx( CItem* pItem , DWORDEX money );
	void RegistItemEx( ITEMBASE ItemInfo, WORD wAbsPosition, WORD Volume , DWORDEX money );
