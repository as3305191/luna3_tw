...
//	cTextArea* m_pTitle;
	...
	DWORDEX m_MoneyArray[SLOT_STREETSTALL_NUM];
...
public:
	...
	void ChangeItemStatus( POSTYPE pos, DWORDEX money, BOOL bLock );
	void ChangeItemStatus( ITEMBASE* pbase, DWORDEX money, BOOL bLock, int nDivideKind = 0 );
