...
BOOL CStreetStallManager::LinkItem( POSTYPE pos, ITEMBASE ItemInfo, WORD Volume, DWORDEX Money)
{
...
//////////////////////////////////////////////////////////////////////////
//판매 아이템 등록 함수
void CStreetStallManager::RegistItemEx( CItem* pItem , DWORDEX money )
{
...
//////////////////////////////////////////////////////////////////////////
//구매 아이템 등록 함수
void CStreetStallManager::RegistItemEx( ITEMBASE ItemInfo, WORD wAbsPosition, WORD Volume, DWORDEX money )
{
...
void CStreetStallManager::LinkBuyItem( STREETSTALL_INFO* pStallInfo )
{
	...
	for( i=0;i<SLOT_STREETSTALL_NUM;++i)
	{
		...
		if( stallItem.Fill )
		{
			...
			{
				DWORD color = 0xffffffff;
				DWORDEX money = stallItem.Durability * stallItem.money;
...
void CStreetStallManager::LinkSellItem( STREETSTALL_INFO* pStallInfo )
{
	...
	for(int i=0;i<SLOT_STREETSTALL_NUM;++i)
	{
		if( pStallInfo->Item[i].Fill )
		{
			...
			DWORD color = 0xffffffff;
			DWORDEX money = pStallInfo->Item[i].money;
			...
			{
				DWORD color = 0xffffffff;
				DWORDEX money = pStallInfo->Item[i].money * pStallInfo->Item[i].wVolume;
