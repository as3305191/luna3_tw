	...
	case MP_STORAGE_PUTIN_MONEY_ACK:
		{
			...
			GAMEIN->GetStorageDialog()->SetStorageMoney(pmsg->dweData);
		}
		break;
...
void CStorageManager::OnPutInMoneyStorageOk( LONG iId, void* p, DWORDEX param1, void * vData1, void * vData2 )
{
	if(param1 == 0)	return;
...
void CStorageManager::OnPutInMoneyStorageCancel( LONG iId, void* p, DWORDEX param1, void * vData1, void * vData2 )
{
}
...
void CStorageManager::OnPutOutMoneyStorageOk( LONG iId, void* p, DWORDEX param1, void * vData1, void * vData2 )
{
	if(param1 == 0)	return;
