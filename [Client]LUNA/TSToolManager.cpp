...
BOOL CTSToolManager::OnRegenCommand()
{
	...
	if( SendMessage( GetDlgItem( m_hWndSub[eTSMenu_Mob], IDC_TSREGEN_BTN_MODEDIRECT ), BM_GETCHECK, 0, 0 ) == BST_CHECKED )
	{
		...
		if( nMobCount > 100 ) return FALSE;	//�ӽ÷� �ѹ��� 100�� ������
		//map
		...
		if( nX < 0 ) nX = 0;	//�ִ밪 üũ�߰�
		if( nY < 0 ) nY = 0;	
		if( nRad < 0 ) nRad = 0;
		else if( nRad > 10000 ) nRad = 10000;	//�ݰ� 100m�� ����
...
//			if (pTriggerList)
			...
			while( questNpcPos )
			{
				...
				if( pQuestNpc )
				{
					...
					while( pos )																		// ��ġ ������ ��ȿ�� ���� while���� ������.
					{
						CQuestNpcData* pData = (CQuestNpcData*)pNpcDataList.GetNext( pos );					// ��ġ�� �ش��ϴ� ����Ʈ npc ������ ������ �޴´�.
