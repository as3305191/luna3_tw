...
//	CMacroModeDialog	* m_pMacroModeDlg;
	...
	*/
	...
	CTransmogDialog*			m_pTransmogDlg;
...
public :
    ...
    CTransmogDialog* GetTransmogDialog()							{ return m_pTransmogDlg; }
	void SetTransmogDialog(CTransmogDialog* pDlg)					{ m_pTransmogDlg=pDlg; }
