...
#define MAX_TOOLTIPSTR_SIZE		256		//KES. �����ϴ�.. 
...
#define TTTC_EXTRAATTR			RGB_HALF( 84, 143, 223 )		//+�ӸӸ�(%)
#define TTTC_EXTRAATTRITEM		TTTC_EXTRAATTR					//��+1�� �Ӽ����� ������
#define TTTC_RAREITEM			RGB_HALF( 85, 252, 85 )		//!�ӽ� ���� ������ 
#define TTTC_NUMBER				RGB_HALF( 84, 143, 223 )		//���ݷ� 0~0
#define TTTC_LIMIT				RGB_HALF( 230, 20,  20 )		//����0���ͻ��
#define TTTC_FREELIMIT			TTTC_DEFAULT					//�������� Ǯ��
#define TTTC_SKILLBOOKKIND		RGB_HALF( 230, 232, 38 )		//�˿ܰ���
#define TTTC_SKILLKIND			RGB_HALF( 230, 232, 38 )		//�ܰ�, ������
#define TTTC_SKILLEXP			RGB_HALF( 230, 232, 38 )		//��������ġ
#define TTTC_SKILLNEEDMANA		RGB_HALF( 230, 232, 38 )		//�ʿ丶��
#define TTTC_SKILLATTRKIND		TTTC_EXTRAATTR					//�����ۼ�����(ȭ�Ӽ�)
...
{ 
	...
	WE_TOPROWCHANGE = 8388608,	// 091209 ShinJS --- List ���� TopListItemIdx�� ����Ǵ� ��� ���
};
...
typedef void (*cbDivideFUNC)( LONG lId, void *p, DWORDEX param1, void * param2, void * param3 );
...
typedef struct _ITEM
{
	...
	// ShinJS 090827 --- item�� String�� Data�� ���Ŀ� Data �߰�
	DWORD dwData;
	DWORD dwSortData;
}ITEM;
