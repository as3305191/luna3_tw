...
{
	AddFontResourceEx( "./Data/Interface/Windows/Tahoma.ttf", FR_PRIVATE, 0 );
	...
	lstrcpy(font.lfFaceName,"Tahoma");
...
//#endif
	...
	CreateTransmogDialog();
}

void cWindowManager::CreateTransmogDialog()
{
	cWindow * window = GetDlgInfoFromFile("Data/Interface/Windows/TransmogDialog.bin", "rb");
	AddWindow(window);
	GAMEIN->SetTransmogDialog((CTransmogDialog *)window);
	GAMEIN->GetTransmogDialog()->Linking();
}
