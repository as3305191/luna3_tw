...
//	m_nCurSelectedItem = pos;
	...
	BUY_REG_INFO temp;
	DWORDEX money = m_MoneyArray[pos];
...
void CStreetBuyStall::OnDivideItem( LONG iId, void* p, DWORDEX param1, void * vData1, void * vData2 )
{
	...
	if( !STREETSTALLMGR->SellItemDur( (DURTYPE)param1 ) )
	{		
		pStall->SellError();
...
void CStreetBuyStall::OnDivideItemCancel( LONG iId, void* p, DWORDEX param1, void * vData1, void * vData2 )
{
	CStreetBuyStall* pStall = (CStreetBuyStall*)vData1;
...
void CStreetBuyStall::RegistMoney( POSTYPE pos, DWORDEX dwMoney )
{
...
void CStreetBuyStall::ChangeItemStatus( POSTYPE pos, WORD volume, DWORDEX money)
{
	CBuyItem * pItem = (CBuyItem*)m_pStallGrid->GetIconForIdx( pos );
	if( !pItem ) return;
	char buf[256] = {0,};
	...
	{
		DWORD color = 0xffffffff;
		DWORDEX money = pItem->GetMoney() * pItem->GetVolume();
