...
public:
	...
	BOOL DeleteItem(POSTYPE Pos,int iNum,CItem** ppItem);
...
private:
	...
	static void OnFakeStorageItemDivideCancel( LONG iId, void* p, DWORDEX param1, void * vData1, void * vData2 );
	static void OnFakeStorageItemDivideOk( LONG iId, void* p, DWORDEX param1, void * vData1, void * vData2 );
};
