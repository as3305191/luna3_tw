...
public:
	...
	void AddMsg(eTextClass, WORD, LPCTSTR, ...);
...
protected:
	cPtrList m_MegaphoneColorList;

private:
	void LoadColorfulMegaphoneList();
	cPtrList& GetMegaphoneList() { return m_MegaphoneColorList; }
};