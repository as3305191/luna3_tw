...
public:
	...
	DWORDEX	GetTotalMoney() { return m_nTotalMoney; };
...
//	void	SetDefaultUsable() { m_nUsable = DEFAULT_USABLE_INVENTORY; };
	...
	// »óÁ¡¿î¿µ Á¦¾î ÇÔ¼ö
	BOOL FillCell(ITEMBASE* pBase, DWORDEX money, BOOL bLock = FALSE, DWORD Volume = 0, WORD wAbsPosition = 0);
	...
	void SetMoney( WORD pos, DWORDEX money );
