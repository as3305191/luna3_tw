...
public:
	...
	void	GiveMoney( PLAYERTYPE* pPlayer, DWORDEX dwMoney );
	BOOL	TakeItem( PLAYERTYPE* pPlayer, DWORD dwQuestIdx, DWORD dwSubQuestIdx, DWORD wItemIdx, DWORD dwItemNum, DWORD dwProbability );
	void	TakeMoney( PLAYERTYPE* pPlayer, DWORDEX dwMoney );
	void	TakeExp( PLAYERTYPE* pPlayer, DWORD dwExp );
	void	TakeSExp( PLAYERTYPE* pPlayer, DWORD dwSExp );	
	void	TakeMoneyPerCount( PLAYERTYPE* pPlayer, DWORD dwQuestIdx, DWORD dwSubQuestIdx, DWORD dwItemIdx, DWORDEX dwMoney );
