...
//const char* const		g_szAudioInitError = "Audio��ġ ���з� Wav��� ����� ����� �� �����ϴ�";
...
BOOL InitTool(HWND hWnd)
{
	...
	// DllCreateInstance �� 3���� ���� DLL�� ��� �ڽ��� ���� ������ �ִ�.�� ���� COM�� �������̽��� 
	// ��� ���ִ� �Լ��̴�. �ϴ� executive�� �͸� ���� �ٸ��� executive�ʱ�ȭ �ÿ� �ڵ����� ������ �ִ�.
	...
	if (hr != S_OK)
	{		
		MessageBox(NULL,"Executive���� ����","Error",MB_OK);
		return FALSE;
	}

	g_pExecutive->InitializeFileStorageWithoutRegistry("FileStorage.dll",
			1024,512,128,FILE_ACCESS_METHOD_ONLY_FILE,NULL,0,20250813);

	g_pExecutive->InitializeWithoutRegistry("Geometry.dll","Renderer.dll",
		hWnd, &dispInfo, 4096, 64,0,1, 0, NULL);
