...
#pragma comment(lib, "..\\Output\\Debug\\SS3DGFunc.lib")
         ...
         LPVOID* ppv)
{
	...
	if (CLSID_4DyuchiGXExecutive == rclsid)
	{
		hr = E_OUTOFMEMORY;
		pIFactory = new CF4DyuchiGXExecutive;
		if (pIFactory)
		{
...
{
	HRESULT hr;
	I4DyuchiGXExecutive*	pExecutive = new CoExecutive;
	if (!pExecutive)
	{
		hr = E_OUTOFMEMORY;
		goto lb_return;
...
STDAPI DllRegisterServer(void)
{
  ...
  StringFromGUID2(CLSID_4DyuchiGXExecutive, wszID, GUID_SIZE);
  ...
  SetRegKeyValue(
    TEXT("CTS.CLSID_4DyuchiGXExecutive.1"),
    TEXT("CLSID"),
    szID);
  ...
  SetRegKeyValue(
    TEXT("CTS.CLSID_4DyuchiGXExecutive"),
    NULL,
   TEXT("CLSID"));
  ...
  SetRegKeyValue(
    szCLSID,
    NULL,
	TEXT("4DyuchiGXExecutive 3D Engine Excutive 2001. yuchi"));
...
STDAPI DllUnregisterServer(void)
{
  ...
  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_4DyuchiGXExecutive\\CurVer"));
  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_4DyuchiGXExecutive\\CLSID"));
  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_4DyuchiGXExecutive"));

  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_4DyuchiGXExecutive.1\\CLSID"));
  RegDeleteKey(HKEY_CLASSES_ROOT, TEXT("CTS.CLSID_4DyuchiGXExecutive.1"));
