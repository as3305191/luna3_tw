...
class CoExecutive : public I4DyuchiGXExecutive
{
	...
	DWORD						m_dwTickIncrease;			// �ֱ� ���������ӿ��� �������������� ������ ����� ƽ, 0���� m_dwTicksPerFrame ���̰��� ����־�� �Ѵ�. Process���� ����.
...
//	CoGXObject*					m_pTracedGXObject;
	...
	CoGXObject*					m_pCameraAttatchedGXObject[MAX_ATTATCH_OBJECTS_NUM];
	float						m_fDistCameraFront[MAX_ATTATCH_OBJECTS_NUM];
	DWORD						m_dwCameraAttatchedGXObjectNum;
...
private:
	...
	// gxobject���� �浹ó���Ҷ� ���� ����.		2002/05/29
	DBG_COLLISION_INFO			m_CollisionInfo;

	DWORD						m_dwBuildTreeFlag;		// octree, bsp tree ���� ���� ����. BUILD_TREE_FLAGŸ��.
...
//	void						RenderDecal();
	...
	BOOL							InitializeFileStorageCommon(DWORD dwMaxFileNum,DWORD dwMaxFileHandleNumAtSameTime,DWORD dwMaxFileNameLen,FILE_ACCESS_METHOD accessMethod,PACKFILE_NAME_TABLE* pPackFileList,DWORD dwNum,DWORD dwSecretKey, BOOL bFileShareMode);
public:
#ifdef _DEBUG
...
//	CoGXObject*					GetTracedGXObject() {return m_pTracedGXObject;}
	...
	HRESULT				__stdcall	GetRenderer(I4DyuchiGXRenderer** ppRenderer);		// Release�ʿ���
	HRESULT				__stdcall	GetGeometry(I4DyuchiGXGeometry** ppGeometry);		// Release�ʿ���
	HRESULT				__stdcall	GetFileStorage(I4DyuchiFileStorage** ppFileStorage);
		
	BOOL				__stdcall	InitializeWithoutRegistry(char* szGeometryFileName,char* szRendererFileName,HWND hWnd,DISPLAY_INFO* pInfo,DWORD dwMaxObjectNum,DWORD dwMaxLightNum,DWORD dwMaxTriggerNum,DWORD dwViewportNum, DWORD dwMaxDecalNum, DWORD dwSecretKey, ErrorHandleProc pErrorHandleFunc);
	...
	BOOL				__stdcall	InitializeFileStorageWithoutRegistry(char* szFileName,DWORD dwMaxFileNum,DWORD dwMaxFileHandleNumAtSameTime,DWORD dwMaxFileNameLen,FILE_ACCESS_METHOD accessMethod,PACKFILE_NAME_TABLE* pPackFileList,DWORD dwNum,DWORD dwSecretKey,BOOL bFileShareMode=FALSE);
	BOOL				__stdcall	InitializeFileStorage(DWORD dwMaxFileNum,DWORD dwMaxFileHandleNumAtSameTime,DWORD dwMaxFileNameLen,FILE_ACCESS_METHOD accessMethod,PACKFILE_NAME_TABLE* pPackFileList,DWORD dwNum,DWORD dwSecretKey,BOOL bFileShareMode=FALSE);
	...
	void				__stdcall	GXOGetInterpolatedPosition( GXOBJECT_HANDLE gxh,VECTOR3* pv3Pos); // �����Ǿ ������ �Ǵ� �������� ���. ���� GXO�� ��ġ�� �ƴϴ�. ī�޶���ġ ������ �� ���� ������.
...
//	void				__stdcall	GXOSetApplyVelocityFlag( GXOBJECT_HANDLE gxh, BOOL bApply);		// �� �����Ӹ��� �ӵ����͸� ������ ���ΰ�?
	...
	VOID				__stdcall	SetPickingMode(DWORD dwPickingMode);		// ���̳� �����̳ĸ� �����ϴ� ������,
																				// ���ӿ����� ��ŷ �������� ������ ����. 
																				// ���� SetRenderMode�� shape�� ����Ͽ� ����� ���� �̸��� �̷��� �� �� ��.	
...
//	void				__stdcall	GXOGetVelocity( GXOBJECT_HANDLE gxo, VECTOR3* pOutVelocity);
	...
	MATRIX4			__stdcall	GXOGetParentMatrix(GXOBJECT_HANDLE gxh);

	// NYJ 090313 - �Ͽ�¡
	BOOL				__stdcall	GXOIsCollisionMeshWithBoundingBox(GXOBJECT_HANDLE gxh, VECTOR3* pv3IntersectPoint,DWORD* pdwModelIndex,DWORD* pdwObjIndex,float* pfDist,COLLISION_MESH_OBJECT_DESC* pSrcColDesc);
	BOOL				__stdcall	GXOIsCollisionMeshWithObjectBoundingBox(GXOBJECT_HANDLE gxhDest, VECTOR3* pv3IntersectPoint,DWORD* pdwModelIndex,DWORD* pdwObjIndex,float* pfDist,GXOBJECT_HANDLE gxhSrc);
	BOOL				__stdcall	GXOIsCollisionBoungingBoxWithScreenCoord(GXOBJECT_HANDLE gxh, VECTOR3* pv3IntersectPoint, VECTOR3* pv3ColTri, POINT* ptCursor,DWORD dwViewportIndex);
	DWORD				__stdcall	GXOGetModelNum(GXOBJECT_HANDLE gxh);
	DWORD				__stdcall	GXOGetObjectNum(GXOBJECT_HANDLE gxh, DWORD dwModelIndex);
	BOOL				__stdcall	GXOGetCollisononObjectDesc(GXOBJECT_HANDLE gxh, COLLISION_MESH_OBJECT_DESC* pDesc, DWORD dwModelIndex, DWORD dwObjectIndex);
	BOOL				__stdcall	GXOGetCollisionModelDesc(GXOBJECT_HANDLE gxh, COLLISION_MODEL_DESC* pDesc, DWORD dwMaxModelNum);

	// pdy 090519 - �Ͽ�¡ 
	BOOL				__stdcall	GXOGetWorldMatrixByName(GXOBJECT_HANDLE gxh , MATRIX4* pMatrix4 ,char* szObjName );
	///
